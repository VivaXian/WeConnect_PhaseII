...
export const MiniProgramNav = ({ title, showBack = false, onBack }: MiniProgramNavProps) => (
    ...
    <div className={s.navBar}>
      ...
      <div className={s.navRight}>
        <div className={s.capsule}>
          <button className={s.capsuleBtn} aria-label="关闭">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
              <path d="M1.5 1.5L12.5 12.5M12.5 1.5L1.5 12.5" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
            </svg>
          </button>
          <div className={s.capsuleDivider} />
          <button className={s.capsuleBtn} aria-label="更多">
