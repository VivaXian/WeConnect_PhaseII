...
export const faqData: FaqItem[] = [
  ...
  },
  {
    ...
    answer: '飞利浦 7x24 小时受理报修，收到后会先做初步判断。需要工程师介入时会为您安排服务工程师，工程师会在这里主动与您联系。',
    priority: 2,
  },
  {
    id: 'faq-3',
  ...
  },
  {
    ...
    answer: '进入设备详情页的「保养」标签，可以查看最近一次保养记录和下一次计划保养时间。如需调整保养安排，可在该页面提交保养咨询登记。',
    priority: 6,
  },
  {
    id: 'faq-7',
  ...
  },
  {
    ...
    answer: '已结束的对话会保留供您查阅，但不再接收新消息。如果同一台设备再次出现问题，请重新提交报修，工程师接手后会在新的对话中与您联系。',
    priority: 8,
  },
];
